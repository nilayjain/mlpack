...
class GoogleNet
{
 public:
  ...
  BaseLayer2D<RectifierFunction> base1, base2, base3, base4, base5;
  ...
  GoogleNet() :
    ...
    linear1(1024, 1000),
    pool6(5, 3),
    conv4(512, 128, 1, 1, 1, 1, 1, 1),
    linear2(4 * 4 * 128, 1024),
    drop2(0.7),
    linear3(1024, 1000),
    pool7(5, 3),
    conv5(528, 128, 1, 1, 1, 1, 1, 1),
    linear4(4 * 4 * 128, 1024),
    drop3(0.7),
    linear5(1024, 1000)
  {

    auto aux2 = std::tie(pool7, conv5, linear4, drop3, linear5, softmax3);
